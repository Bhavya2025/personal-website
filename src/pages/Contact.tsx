...
/**
 * Contact page: a daylight sky with a resident pigeon that splits its
 * time between the contact buttons (~70%), your idle cursor, and its
 * nest on the grass. Departing a button it pecks that icon loose and
 * hoards it in the nest. The shared footer sits below.
 */
function Contact() {
  usePageReveals()
